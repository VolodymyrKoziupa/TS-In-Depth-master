...
export function createCustomer(name: string, age?: number, city?: string): void {
    ...
    if (city) {
        console.log(`Cistomer city: ${city}`)
    }
}
...
export function checkoutBooks(cunstomer: string, ...bookIDs: number[]): string[] {
    console.log(`Customer name: ${cunstomer}`)
    return bookIDs
...
export function bookTitleTrasform(title: any): string {
...
export function getBooksByCategory(category: Category, callback: LibMgrCallback): void {
    // export function getBooksByCategory(catagory: Category, callback: Callback<string[]>): void
    setTimeout(() => {
        try {
